module.exports = function(viewConfig, fileName, templateName) {
  var templateKey = tranformStrToCamelCase(fileName);

  templateKey = viewConfig.viewType + templateKey;
  if (!!templateName) {
    templateKey = templateName;
  }
  return templates[templateKey] ? templates[templateKey](viewConfig.viewName) : '';
};
